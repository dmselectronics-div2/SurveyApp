...
const StartPageB = () => {
    ...
    const [value, setValue] = React.useState('middle');
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            navigation.navigate('StartPageC');
        }, 2000);
...
        };return () => clearTimeout(timer); // Cleanup the timer
    ...
    return (
        <ImageBackground
            source={require('./../../assets/image/imageB.jpg')}
            ...
            <View style={styles.title_container}>
                ...
                <View style={styles.container}>
                    <View style={shadowStyles.shadow}>
                        <Text style={styles.sub_text}>“Many fish, birds, </Text>
                        <Text style={styles.sub_text}>and other animals </Text>
                        <Text style={styles.sub_text}>live in mangrove</Text>
                        <Text style={styles.sub_text}>forests."</Text>
                    </View>
                </View>
            </View>
            <View style={styles.button_group}>
                <ToggleButton.Row onValueChange={value => setValue(value)} value={value} style={styles.toggleButtonRow} >
                    <ToggleButton icon="circle" value="left" iconColor='#DADADA' size={20} style={styles.toggleButton} />
                    <ToggleButton icon="circle" value="middle" iconColor='white' size={20} />
