...
const DisplayTable = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/get-all-bivalvi?page=${currentPage}&limit=${entriesPerPage}`);
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/update-bivalvi-info/${editItem._id}`, {
        method: 'PUT',
        headers: {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const response = await fetch(`${API_URL}/delete-bivalvi-info/${id}`, {
                method: 'DELETE',
              });
  ...
  // Navigate back
  const handleBack = () => {
    navigation.navigate('DropdownComponent');
  };
