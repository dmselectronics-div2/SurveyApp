...
export const GOOGLE_WEB_CLIENT_ID = '617218324734-2bnsqmibeaq21k5iruiisvtvh22cv32r.apps.googleusercontent.com';

// Network configuration
export const API_TIMEOUT = 15000; // 15 seconds
export const ENABLE_OFFLINE_MODE = true; // Show "No Data" gracefully when offline
