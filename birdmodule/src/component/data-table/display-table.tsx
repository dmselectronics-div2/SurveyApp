...
const MyDataTable = ({ point, startDate, endDate }) => {
  ...
  useEffect(() => {
    ...
    console.log('row data are ', email);
  }, []);
  ...
  // Handle Delete: Check if the email matches before allowing deletion
...
const styles = StyleSheet.create({
    ...
    lightHeaderRow: {
      ...
      backgroundColor: 'rgba(163,165,169,0.43)',
    },
    darkHeaderRow: {
